...
$consultaradmin = "SELECT * FROM maestros"; //indicar de donde se hara la consulta
        ...
        <div class="col-12">
          <table class="table mt-5">
            <thead class="thead-dark">  <!--dar color-->
              <tr><!--crear filas-->
                <th scope="col">ID_Maestro</th> <!--agregarcolumnas-->
                <th scope="col">Nombre_Maestro</th>
                <th scope="col">Apellido_Maestro</th>
                <th scope="col">Materia</th>
                <th scope="col">Correo_Profesor</th>
              ...
              //verificar que tenga registros
              {
                while($row = $result->fetch_assoc()){  //fetch convierte la info en arreglos, 
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['Nombre_Mst']; ?></td>
                    <td><?php echo $row['Apellido_Mst']; ?></td>
                    <td><?php echo $row['Materia']; ?></td>
                    <td><?php echo $row['Correo']; ?></td>
                    <td><a class="btn btn-info" href="ModificarProfesores.php?Id_Maestro=<?php echo $row['Id_Maestro'];?>">Edit</a> &nbsp;
                    <a class="btn btn-danger" href="EliminarProfesores.php?Id_Maestro=<?php echo $row ['Id_Maestro'];?>">Delete</a>
