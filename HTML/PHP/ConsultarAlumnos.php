...
$consultaradmin = "SELECT * FROM alumnos"; //indicar de donde se hara la consulta
        ...
        <div class="col-12">
          <table class="table mt-5">
            <thead class="thead-dark">  <!--dar color-->
              <tr><!--crear filas-->
                <th scope="col">ID_Al</th> <!--agregarcolumnas-->
                <th scope="col">Nombre_Al</th>
            ...
            <tbody>
              ...
              //verificar que tenga registros
              {
                while($row = $result->fetch_assoc()){  //fetch convierte la info en arreglos, 
                  ?>
                  <tr>
                    <td><?php echo $row['ID_Al']; //ID_Al=210854 ?></td>
                    ...
                    <td><a class="btn btn-info" href="ModificarAlumnos.php?ID_Al=<?php echo $row['ID_Al'];?>">Edit</a> &nbsp;
                    <a class="btn btn-danger" href="EliminarAlumnos.php?ID_Al=<?php echo $row ['ID_Al'];?>">Delete</a>
